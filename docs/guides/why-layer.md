...
The Why layer indexes local Claude Code, Codex, DeepSeek Harness, Pi, and ThoughtDAG canvas conversations together. Start with a file, an exact phrase, a URL, or an arXiv paper id; the result points back to the matching turn.
