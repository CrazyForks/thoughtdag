...
<img src="docs/memory-page-zh.png" alt="记忆页：你（偏好与身份）、每个项目一份档案并标出有多少新内容、打开的档案带分段与来源" width="100%"/>
...
<p align="center"><img src="docs/recall-panel-zh.png" alt="宽泛提问后的侧栏：回忆带进两份档案，卡片列出并标价，数字折在「怎么选的」里" width="420"/></p>
